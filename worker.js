...
function blinkLiveNumbers(){if(holdActive)return;const nodes=[document.getElementById("resultDigits"),document.getElementById("setValue"),document.getElementById("valueValue")];if(nodes.some(n=>!n||n.textContent.trim()==="--"))return;nodes.forEach(n=>n.classList.remove("live-change"));void nodes[0].offsetWidth;nodes.forEach(n=>n.classList.add("live-change"))}
